                ...
                <div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-between mt-1 pt-4 border-t border-border-color">
                      ...
                      <button onClick={() => console.log('Exporting CSV...')} className="bg-bg-deep hover:bg-bg-panel border border-border-color text-text-main px-3 py-1.5 rounded text-[12px] font-medium transition-colors outline-none cursor-pointer">
                        Export Log (.csv)
                      </button>
                    </div>
                  </div>
